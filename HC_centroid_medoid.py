...
class HC_centroid_medoid:
    ...
    def updata(self):
        ...
        new_dsim_list, new_medoid_index = self.cal_dsim(cluster_1_index = min_dsim_search_list_index[0][0], cluster_2_index = min_dsim_search_list_index[1][0]) #追加する非類似度行列を取得
